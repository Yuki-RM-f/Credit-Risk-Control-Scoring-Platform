...
1. 进入“申请审批”，选择低风险客户并提交评分，结果为自动通过。
2. 选择中风险客户提交评分，进入“人工复核”，提交复核通过。
3. 选择高风险客户提交评分，结果为自动拒绝。
4. 进入“策略中心”，调整阈值和成本矩阵，查看通过/复核/拒绝率与总成本。
5. 进入“报表中心”，模拟标签回流后查看回流指标和模型效果。
